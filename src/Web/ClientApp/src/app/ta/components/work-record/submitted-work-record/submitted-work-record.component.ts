...
@Component({
  selector: 'app-submitted-work-record',
  templateUrl: './submitted-work-record.component.html',
  styleUrls: ['./submitted-work-record.component.css']
})
export class SubmittedWorkRecordComponent  implements OnInit,AfterViewInit  {
  ...
  getWorkRecord(userId){
    this.TAClient.getWorkRecord22(userId,true).subscribe((responce) => {
