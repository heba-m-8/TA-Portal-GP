...
import { PhdTAClient, TAClient, WorkRecordDto } from 'src/app/web-api-client';
...
export class RejectedWorkRecordComponent implements OnInit, AfterViewInit {
  ...
  WorkRecordList: any[] = [];
  constructor(private phdTAClient: PhdTAClient, private router: Router, private TAClient: TAClient) {
