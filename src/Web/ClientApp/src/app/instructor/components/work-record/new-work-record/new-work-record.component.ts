...
export class NewWorkRecordComponent  implements OnInit, AfterViewInit {
  ...
  constructor(private instructorClient: InstructorClient, private dialog: MatDialog,private router: Router) {
  ...
  getWorkRecord(userId) {
    this.instructorClient.getWorkRecord(userId).subscribe((responce) => {
