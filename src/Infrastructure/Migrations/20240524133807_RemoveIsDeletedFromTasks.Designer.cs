...
namespace TAManagment.Infrastructure.Migrations
{
    ...
    [Migration("20240524133807_RemoveIsDeletedFromTasks")]
    partial class RemoveIsDeletedFromTasks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TAManagment.Domain.Entities.WorkRecord", b =>
                {
                    ...
                    b.Property<string>("DeanNote")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DeanOfGraduateStudiesNote")
                        .HasColumnType("nvarchar(max)");
